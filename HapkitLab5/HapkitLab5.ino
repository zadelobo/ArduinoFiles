...
void loop()
{
  ...
  double k1 = 20; // in N/m
  double k2 = 20; // in N/m
  double xclick = 1; // in m
  if ((xh > 0) && (xh < xclick)) 
  {
    force = -k1*xh;  // render a spring k1 for the first phase of the press
  } 
  else if (xh > xclick) 
  {
    force = -k2*(xh-xclick);  // render a spring k2 for the second phase of the press
  }
  else
  {
    force=0;
